...
import UpcomingSportsSvg from "@/app/[locale]/components/common/svg_icons/upcoming-sports-svg";
import SportsDoc from "./sports-doc";
import BackRedirectHandler from "@/app/[locale]/components/common/Back-redirect-handler";

interface UpcomingSportsPageProps {
  searchParams: { [key: string]: string | string[] | undefined };
}

async function UpcomingSportsPage({ searchParams }: UpcomingSportsPageProps) {
  ...
  const featuredData = [
    {
      name: "All",
      matches: 120,
      contentImage: "all_sports_f6qeir",
    },
  ];
...
export default UpcomingSportsPage;
